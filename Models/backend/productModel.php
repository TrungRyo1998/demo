	...
	*/
	trait productModel{
		...
		public function executeEdit(){
			...
			$query = $db->prepare("update tbl_product set name=:name, category_id=:category_id, description=:description, content=:content, price=:price, hotproduct=:hotproduct where id=:id");
			$query->execute(array("name"=>$name,"category_id"=>$category_id,"description"=>$description,"content"=>$content, "price"=>$price , "hotproduct"=>$hotproduct,"id"=>$id));
		...
		public function executeAdd(){
			...
			$db = connection::getInstance(); //Core/connection.php
			//update email, fullname tuong ung voi ban ghi co id truyen vao
			$query = $db->prepare("insert into tbl_product set name=:name, category_id=:category_id, description=:description, content=:content, price=:price, hotproduct=:hotproduct, img=:img");
			$query->execute(array("name"=>$name,"category_id"=>$category_id,"description"=>$description,"content"=>$content,"price"=>$price,"hotproduct"=>$hotproduct,"img"=>$img));
			//-------------------------		
		}
